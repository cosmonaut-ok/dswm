...
;;; Commentary:
;;
;; There are those for whom simply using a window manager like DSWM
...
;; any of your DSWM keymaps. That's right--the window manager is
...
;;             ("Print" "screenshot")))
;;
;; `*productivity-start-message*': What DSWM should print when you
;;     start productivity-mode.
;;
;; `*productivity-stop-message*': What DSWM should print when you
;;     stop productivity-mode
;;
;; `*productivity-back-to-work-message*': What DSWM should print
...
;;         package? (Just in case somebody insinuates that DSWM
...
;;
;; - [ ] Add an option to disable dsish, slime and/or
;;       dswm-mode.el (choose your poison/s).
;;
...
(defvar *productivity-stop-message* "Break time!"
  "What should DSWM print when you stop productivity-mode?")

(defvar *productivity-start-message* "Get to work!"
  "What should DSWM print when you start productivity-mode?")

(defvar *productivity-back-to-work-message* "Get back to work!"
  "What should DSWM print when you attempt to waste time?")
